...
# TestP2PConn: A peer we use to send messages to connexd, and store responses.
...
class CompactBlocksTest(CONNEXTestFramework):
    ...
    # This test actually causes connexd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that connexd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for connexd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # connexd will not send blocktxn responses for blocks whose height is
