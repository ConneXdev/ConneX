...
class BIP66Test(CONNEXTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # connexd is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and connexd produces more specific reject
            # reasons.
