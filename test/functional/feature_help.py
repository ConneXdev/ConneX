...
"""Verify that starting connex with -h works as expected."""

from test_framework.test_framework import CONNEXTestFramework
from test_framework.util import assert_equal

class HelpTest(CONNEXTestFramework):
    ...
    def run_test(self):
        self.log.info("Start connex with -h for help text")
        ...
        self.log.info("Start connex with -version for version information")
        ...
        self.log.info("Start connexd with -fakearg to make sure it does not start")
