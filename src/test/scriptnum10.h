...
#ifndef CONNEX_TEST_SCRIPTNUM10_H
#define CONNEX_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from CONNEX Core 0.10.0, for cross-comparison.
 */
public:
