...
{
    BOOST_CHECK(TestSplitHost("www.connexcore.org", "www.connexcore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.connexcore.org]", "www.connexcore.org", -1));
    BOOST_CHECK(TestSplitHost("www.connexcore.org:80", "www.connexcore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.connexcore.org]:80", "www.connexcore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:7456", "127.0.0.1", 7456));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:7456", "127.0.0.1", 7456));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:7456", "::ffff:127.0.0.1", 7456));
    BOOST_CHECK(TestSplitHost("[::]:7456", "::", 7456));
    BOOST_CHECK(TestSplitHost("::7456", "::7456", -1));
    BOOST_CHECK(TestSplitHost(":7456", "", 7456));
    BOOST_CHECK(TestSplitHost("[]:7456", "", 7456));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:7456", "127.0.0.1:7456"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:7456", "[::]:7456"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
