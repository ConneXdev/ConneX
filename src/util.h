 ...
 */
#ifndef CONNEX_UTIL_H
#define CONNEX_UTIL_H
...
extern const char * const CONNEX_CONF_FILENAME;
extern const char * const CONNEX_PID_FILENAME;
...
{
    std::string s = strprintf("connex-%s", name);
