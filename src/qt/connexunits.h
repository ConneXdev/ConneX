...
#ifndef CONNEX_QT_CONNEXUNITS_H
#define CONNEX_QT_CONNEXUNITS_H
...
/** CONNEX unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class CONNEXUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit CONNEXUnits(QObject *parent);

    /** CONNEX units.
      @note Source: https://en.connex.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        CNX,
...
typedef CONNEXUnits::Unit CONNEXUnit;

#endif // CONNEX_QT_CONNEXUNITS_H
