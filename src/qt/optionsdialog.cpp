    ...
    mapper(0)
{
    ...
    ui->connexAtStartup->setToolTip(ui->connexAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->connexAtStartup->setText(ui->connexAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openCONNEXConfButton->setToolTip(ui->openCONNEXConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new CONNEXUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->connexAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openCONNEXConfButton_clicked()
{
