...
#ifndef CONNEX_KEYSTORE_H
#define CONNEX_KEYSTORE_H
...
public:
    ...
    //! Support for BIP 0013 : see https://github.com/connex/bips/blob/master/bip-0013.mediawiki
