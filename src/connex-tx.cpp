...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " connex-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  connex-tx [options] <hex-tx> [commands]  Update hex-encoded connex transaction\n" +
            "or:     connex-tx [options] -create [commands]   Create hex-encoded connex transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded connex transaction
