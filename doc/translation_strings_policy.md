...
This document provides guidelines for internationalization of the CONNEX Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `connex_en.ts` remains unchanged.
