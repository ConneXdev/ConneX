...
* connex.conf: contains configuration settings for connexd or connex-qt
* connexd.pid: stores the process id of connexd while running
...
* debug.log: contains debug information and general logging generated by connexd or connex-qt
